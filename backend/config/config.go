...
type Config struct {
	...
	GSCOAuthClientSecretFile      string
	GSCOAuthTokenFile             string
	GSCResourceSyncDelaySeconds   string
	GSCAPIRateLimitRetries        string
	GSCAPIRateLimitBackoffSeconds string
...
func Load() (*Config, error) {
	cfg := &Config{
		...
		GSCOAuthClientSecretFile:      getEnv("GSC_OAUTH_CLIENT_SECRET_FILE", ""),
		GSCOAuthTokenFile:             getEnv("GSC_OAUTH_TOKEN_FILE", ""),
		GSCResourceSyncDelaySeconds:   getEnv("GSC_RESOURCE_SYNC_DELAY_SECONDS", "6"),
		GSCAPIRateLimitRetries:        getEnv("GSC_API_RATE_LIMIT_RETRIES", "3"),
		GSCAPIRateLimitBackoffSeconds: getEnv("GSC_API_RATE_LIMIT_BACKOFF_SECONDS", "30"),
